...
<div class="slds-grid slds-p-top--xx-large">
				...
				<b>Test13 Application</b>    
<div class="slds-col">
            <c:CircularProgressBar themeAfterThreshold="red" themeBeforeThreshold="green" size="medium" totalProgress="12" actualProgress="14" Legend="Result format" resultFormat="Mix" threshold="200" />  
        </div>
<div class="slds-col">
